setwd("D:/my project/2022 SS-miRNA/ML")
sink("D:/my project/2022 SS-miRNA/ML/log.info", split = TRUE)
library(xgboost)
library(magrittr)
library(ggplot2)
library(reshape2)
...
sample_scale = 1000 # pos samples everytime 

#load and construct input data
array<-read.table("SS_NSS_feature_for_ML_new.tsv",header = T)
